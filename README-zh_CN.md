...
* 集成了 ...
* 自带 IDE 帮助文件
* 自带 `github/pages` docsify [文档网站](https://guanguans.github.io/filament-login-captcha/)
* 自带常用徽章图标
* 自带中英文 `README.md` 文件
...
5. 替换 `GuanguansFilamentLoginCaptchaUpdateHelper` -> `VendorNamePackageNameUpdateHelper`
6. 替换 `filament-login-captcha` -> `your repository name`
